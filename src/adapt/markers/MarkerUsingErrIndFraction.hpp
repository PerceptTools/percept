...
public:
  ...
  virtual bool refine_element  (const double error) {return (error > (markerInfo_.refineFraction_)  *(markerInfo_.maxErrorIndicator_));}
  virtual bool unrefine_element(const double error) {return (error < (markerInfo_.unrefineFraction_)*(markerInfo_.maxErrorIndicator_));}
