...
template<> RefTopoX RefinementTopologyExtra< shards:: Wedge<15>  > :: refinement_topology = {
  ...
  {	24,	2,	0,	7,	9,	{0.25,	0,	0} },
  {	25,	2,	0,	5,	9,	{0.75,	0,	0} },
  {	26,	2,	1,	7,	9,	{0.75,	0.25,	0} },
  {	27,	2,	1,	5,	9,	{0.25,	0.75,	0} },
  {	28,	2,	2,	6,	9,	{0,	0.75,	0} },
  {	29,	2,	2,	4,	9,	{0,	0.25,	0} },
  {	30,	1,	3,	0,	3,	{0.25,	0,	1} },
  {	31,	1,	3,	1,	3,	{0.75,	0,	1} },
  ...
  {	45,	1,	6,	0,	3,	{0,	0,	-0.5} },
  {	46,	2,	0,	4,	9,	{0.5,	0,	-0.5} },
  {	47,	1,	7,	0,	3,	{1,	0,	-0.5} },
  {	48,	2,	1,	4,	9,	{0.5,	0.5,	-0.5} },
  {	49,	1,	8,	0,	3,	{0,	1,	-0.5} },
  {	50,	2,	2,	7,	9,	{0,	0.5,	-0.5} },
  {	51,	1,	6,	1,	3,	{0,	0,	0.5} },
  {	52,	2,	0,	6,	9,	{0.5,	0,	0.5} },
  {	53,	1,	7,	1,	3,	{1,	0,	0.5} },
  {	54,	2,	1,	6,	9,	{0.5,	0.5,	0.5} },
  {	55,	1,	8,	1,	3,	{0,	1,	0.5} },
  {	56,	2,	2,	5,	9,	{0,	0.5,	0.5} }
 ...
 *     double parametric_coordinates[3];
 */
// ref element is [-1,1]x[-1,1]x[0,1]
template<> RefTopoX RefinementTopologyExtra< shards:: Pyramid<13>  > :: refinement_topology = {
  ...
  {	7,	1,	2,	2,	3,	{0,	1,	0} },
  {	8,	1,	3,	2,	3,	{-1,	0,	0} },
  {	9,	1,	4,	2,	3,	{-0.5,	-0.5,	0.5} },
  {	10,	1,	5,	2,	3,	{0.5,	-0.5,	0.5} },
  {	11,	1,	6,	2,	3,	{0.5,	0.5,	0.5} },
  {	12,	1,	7,	2,	3,	{-0.5,	0.5,	0.5} },
  {	13,	2,	4,	8,	9,	{0,	0,	0} },
  {	14,	1,	0,	0,	3,	{-0.5,	-1,	0} },
  {	15,	1,	0,	1,	3,	{0.5,	-1,	0} },
  {	16,	1,	1,	0,	3,	{1,	-0.5,	0} },
  ...
  {	24,	2,	4,	6,	9,	{0.5,	0,	0} },
  {	25,	2,	4,	5,	9,	{0,	0.5,	0} },
  {	26,	1,	4,	0,	3,	{-0.75,	-0.75,	0.25} },
  {	27,	2,	0,	0,	3,	{-0.25,	-0.75,	0.25} },
  {	28,	2,	0,	1,	3,	{0.25,	-0.75,	0.25} },
  {	29,	1,	5,	0,	3,	{0.75,	-0.75,	0.25} },
  {	30,	2,	0,	2,	3,	{0,	-0.5,	0.5} },
  {	31,	2,	3,	0,	3,	{-0.75,	-0.25,	0.25} },
  {	32,	1,	4,	1,	3,	{-0.25,	-0.25,	0.75} },
  {	33,	1,	5,	1,	3,	{0.25,	-0.25,	0.75} },
  {	34,	2,	1,	0,	3,	{0.75,	-0.25,	0.25} },
  {	35,	2,	3,	1,	3,	{-0.5,	0,	0.5} },
  {	36,	2,	1,	2,	3,	{0.5,	0,	0.5} },
  {	37,	2,	3,	2,	3,	{-0.75,	0.25,	0.25} },
  {	38,	1,	7,	1,	3,	{-0.25,	0.25,	0.75} },
  {	39,	1,	6,	1,	3,	{0.25,	0.25,	0.75} },
  {	40,	2,	1,	1,	3,	{0.75,	0.25,	0.25} },
  {	41,	2,	2,	2,	3,	{0,	0.5,	0.5} },
  {	42,	1,	7,	0,	3,	{-0.75,	0.75,	0.25} },
  {	43,	2,	2,	1,	3,	{-0.25,	0.75,	0.25} },
  {	44,	2,	2,	0,	3,	{0.25,	0.75,	0.25} },
  {	45,	1,	6,	0,	3,	{0.75,	0.75,	0.25} },
  {	46,	3,	0,	0,	4,	{-0.25,	-0.25,	0.25} },
  {	47,	3,	0,	1,	4,	{0.25,	-0.25,	0.25} },
  {	48,	3,	0,	2,	4,	{-0.25,	0.25,	0.25} },
  {	49,	3,	0,	3,	4,	{0.25,	0.25,	0.25} }
...
template<> RefTopoX RefinementTopologyExtra< shards:: Hexahedron<27>  > :: refinement_topology = {
  ...
  {	79,	3,	0,	5,	27,	{0,	0,	-0.5} },
  {	80,	3,	0,	6,	27,	{0,	0,	0.5} },
  {	81,	3,	0,	7,	27,	{-0.5,	-0.5,	-0.5} },
  {	82,	3,	0,	8,	27,	{0.5,	-0.5,	-0.5} },
  {	83,	3,	0,	9,	27,	{0.5,	0.5,	-0.5} },
  {	84,	3,	0,	10,	27,	{-0.5,	0.5,	-0.5} },
  {	85,	3,	0,	11,	27,	{-0.5,	-0.5,	0.5} },
  {	86,	3,	0,	12,	27,	{0.5,	-0.5,	0.5} },
  {	87,	3,	0,	13,	27,	{0.5,	0.5,	0.5} },
  {	88,	3,	0,	14,	27,	{-0.5,	0.5,	0.5} },
