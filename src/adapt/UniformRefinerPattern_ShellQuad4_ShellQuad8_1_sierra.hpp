...
#ifndef adapt_UniformRefinerPattern_ShellQuad4_ShellQuad8_1_sierra_hpp
#define adapt_UniformRefinerPattern_ShellQuad4_ShellQuad8_1_sierra_hpp


#include <adapt/sierra_element/RefinementTopology.hpp>
#include <adapt/sierra_element/StdMeshObjTopologies.hpp>

#define EDGE_QU4_QU8_1_BREAKER 1
#if EDGE_QU4_QU8_1_BREAKER
...
#include "UniformRefinerPattern_Quad4_Quad8_1_sierra.hpp"
  ...
  namespace percept {
    ...
    template <>
    class UniformRefinerPattern<shards::ShellQuadrilateral<4>, shards::ShellQuadrilateral<8>, 1, SierraPort > :
      public URP<shards::ShellQuadrilateral<4>,shards::ShellQuadrilateral<8>  >
    {


#if EDGE_QU4_QU8_1_BREAKER
      UniformRefinerPattern<shards::ShellLine<2>, shards::ShellLine<3>, 1, SierraPort > * m_edge_breaker;
      UniformRefinerPattern<shards::Quadrilateral<4>, shards::Quadrilateral<8>, 1, SierraPort > * m_face_breaker;
#endif

    public:

      UniformRefinerPattern(percept::PerceptMesh& eMesh, BlockNamesType block_names = BlockNamesType()) :
        URP<shards::ShellQuadrilateral<4>, shards::ShellQuadrilateral<8>  >(eMesh)
      {
        ...
        if (m_eMesh.get_spatial_dim() == 3)
          {
            ...
            m_face_breaker = new UniformRefinerPattern<shards::Quadrilateral<4>, shards::Quadrilateral<8>, 1, SierraPort > (eMesh, block_names) ;
          }
#endif
