...
#ifndef ReferenceMeshSmootherNewton_hpp
#define ReferenceMeshSmootherNewton_hpp
...
#include <TpetraBaseLinearSystem.h>
  ...
  namespace percept {
    ...
    class ReferenceMeshSmootherNewton : public ReferenceMeshSmootherConjugateGradient {

    public:

      /// max_edge_length_factor: used for scaling gradients to approximately this value times local edge length
      ReferenceMeshSmootherNewton(PerceptMesh *eMesh,
        ...
        : ReferenceMeshSmootherConjugateGradient(eMesh, boundary_selector, meshGeometry, inner_iterations, grad_norm, parallel_iterations),
          m_isSetup(false)
      {}

      ~ReferenceMeshSmootherNewton();
