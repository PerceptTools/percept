...
class UseCases(unittest.TestCase):
    ...
    def test_fieldFunction_demo_2(self):   
        ...
        f_coords = eMesh.get_field(FEMMetaData.NODE_RANK, "coordinates")                # get pre-existing field
        coords_mag_field = eMesh.get_field(FEMMetaData.NODE_RANK, "coords_mag_field")   # get the field we just created
