...
class UniformRefinerUnitTests(unittest.TestCase):
  ...
  def test_break_quad_to_quad_sierra_1_unit1(self):
    ...
    if p_size <= 3:
       ...
       while i < 2:
         ...
         scalarDimension = 0
         proc_rank_field = eMesh1.add_field("proc_rank", stk::topology::ELEMENT_RANK, scalarDimension)
  ...
  def test_break_quad4_to_quad9_to_quad9_0(self):
    ...
    if p_size <= 1:
      ...
      proc_rank_field = em1.add_field("proc_rank", stk::topology::ELEMENT_RANK, scalarDimension)
