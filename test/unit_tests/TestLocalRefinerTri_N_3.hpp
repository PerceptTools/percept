...
#ifndef adapt_TestLocalRefinerTri_N_3_hpp
#define adapt_TestLocalRefinerTri_N_3_hpp
...
#include <adapt/Refiner.hpp>
  ...
  namespace percept {
    ...
    void TestLocalRefinerTri_N_3::buildTestUnrefineList(ElementUnrefineCollection& elements_to_unref)
    {
