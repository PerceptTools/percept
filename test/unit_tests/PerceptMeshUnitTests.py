...
class PerceptMeshUnitTests(unittest.TestCase):
    ...
    def test_high_level_interface(self):
      ...
      if p_size <= 2:
        ...
        f_coords = eMesh.get_field(MetaData.NODE_RANK, "coordinates")
        coords_mag_field = eMesh.get_field(MetaData.NODE_RANK, "coords_mag_field")
    ...
    def test_time_dep_interface(self):
      ...
      if p_size <= 2:
        ...
        Tnd_field = eMesh.get_field(MetaData.NODE_RANK, "Tnd")
