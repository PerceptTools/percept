...
#ifndef adapt_TestLocalRefinerTet_N_1_hpp
#define adapt_TestLocalRefinerTet_N_1_hpp
...
#if 0
    void TestLocalRefinerTet_N_1::buildTestUnrefineList(ElementUnrefineCollection& elements_to_unref)
    {
