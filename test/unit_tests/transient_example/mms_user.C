...
extern "C" SFAD2_Type euler_p(const SFAD2_Type & x,
			    const SFAD2_Type & y,
			    const SFAD2_Type & z,
			    const SFAD2_Type & t) {
...
extern "C" SFAD2_Type euler_T(const SFAD2_Type & x,
			    const SFAD2_Type & y,
			    const SFAD2_Type & z,
			    const SFAD2_Type & t) {
...
extern "C" SFAD2_Type euler_u(const SFAD2_Type & x,
			    const SFAD2_Type & y,
			    const SFAD2_Type & z,
			    const SFAD2_Type & t) {
...
extern "C" SFAD2_Type euler_v(const SFAD2_Type & x,
			    const SFAD2_Type & y,
			    const SFAD2_Type & z,
			    const SFAD2_Type & t) {
...
{
  sierra::Plugin::UserSubroutine<scalar_SFAD2_function>::instance().
