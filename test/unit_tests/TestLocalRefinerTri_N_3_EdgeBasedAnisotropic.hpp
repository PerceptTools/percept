...
#ifndef adapt_TestLocalRefinerTri_N_3_EdgeBasedAnisotropic_hpp
#define adapt_TestLocalRefinerTri_N_3_EdgeBasedAnisotropic_hpp
  ...
  namespace percept {
	...
	eMesh.get_fem_meta_data()->globally_shared_part();
      ...
      stk::mesh::BucketVector const& buckets =
        eMesh.get_bulk_data()->get_buckets( stk::topology::NODE_RANK, selector );
    ...
    int
    TestLocalRefinerTri_N_3_EdgeBasedAnisotropic::markEdge(
      const stk::mesh::Entity element,
      unsigned which_edge,
      stk::mesh::Entity node0,
      stk::mesh::Entity node1,
